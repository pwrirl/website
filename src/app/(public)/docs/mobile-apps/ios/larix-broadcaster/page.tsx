      ...
      <div className="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row gap-12">
        ...
        <section className="flex-1">
          ...
          <p className="text-gray-400 max-w-2xl mb-12 text-lg">
            A comprehensive guide to setting up Larix Broadcaster for IRL streaming on iOS. Learn how to configure your stream settings, optimize performance, and start broadcasting with professional quality.
          </p>
            ...
            <div className="bg-[#23232b] rounded-xl p-6">
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">iOS 13.0 or later</span>
                </li>
                <li className="flex items-start gap-3">
                  <Icon icon="mdi:check-circle" className="text-[#e20074] mt-1 flex-shrink-0" />
