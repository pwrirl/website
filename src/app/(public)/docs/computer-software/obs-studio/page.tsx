      ...
      <div className="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row gap-12">
        ...
        <section className="flex-1">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-6 relative inline-block">
            <span className="relative z-10">OBS Studio Tutorial for IRL Streaming</span>
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#E20074]" />
          </h1>
          <p className="text-gray-400 max-w-2xl mb-12 text-lg">
            A comprehensive guide to setting up OBS Studio for IRL streaming. Learn about hardware requirements, software configuration, and best practices for professional IRL broadcasts.
          </p>
          ...
          <div className="bg-[#23232b] rounded-xl p-6 mb-12">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#installation" className="text-[#e20074] hover:text-[#e20074]/80">Installing OBS Studio</a></li>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <section id="introduction" className="scroll-mt-24">
              ...
              <p className="text-gray-300 leading-relaxed">
                OBS Studio is a free, open-source software for video recording and live streaming, ideal for IRL (In Real Life) streaming. IRL streaming involves broadcasting real-world activities using mobile devices or portable setups. This tutorial guides you through setting up OBS Studio for IRL streaming, covering hardware, software configuration, and best practices. OBS is completely free to use, with no watermarks or limitations, and is safe to use as it's open-source and regularly updated by a community of contributors.
              </p>
            </section>

            <section id="hardware" className="scroll-mt-24 mt-12">
              <h2 className="text-2xl font-bold text-white mb-4">Hardware Requirements</h2>
              <p className="text-gray-300 mb-4">OBS Studio is flexible and can run on various hardware configurations. For IRL streaming, we recommend:</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#23232b] rounded-xl p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-300">Windows 8.1+, macOS 10.13+, or Linux with basic CPU/GPU</span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-[#23232b] rounded-xl p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <Icon icon="mdi:laptop" className="text-[#e20074] mt-1 flex-shrink-0" />
                      <span className="text-gray-300">Modern CPU (Intel i5/Ryzen 5 or better) with 8GB+ RAM</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon icon="mdi:wifi" className="text-[#e20074] mt-1 flex-shrink-0" />
            ...
            <section id="installation" className="scroll-mt-24 mt-12">
              <h2 className="text-2xl font-bold text-white mb-4">Installing OBS Studio</h2>
              <div className="bg-[#23232b] rounded-xl p-6">
                <ol className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-300">Download OBS Studio from <a href="https://obsproject.com" className="text-[#e20074] hover:text-[#e20074]/80" target="_blank" rel="noopener noreferrer">obsproject.com</a></p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-300">Launch OBS Studio and complete the Auto-Configuration Wizard, selecting "Optimize for streaming"</p>
                    </div>
                  </li>
                </ol>
              </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span className="text-gray-300">Add "Media Source" in OBS</span>
                      </li>
                      <li className="flex items-start gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <ul className="space-y-1 text-gray-300">
                          ...
                          <li>• Encoder: x264 or NVENC (use NVENC if you have an NVIDIA GPU)</li>
                ...
                <div className="bg-[#23232b] rounded-xl p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-300">Keep OBS updated and whitelist it in your antivirus software</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-[#23232b] rounded-xl p-6">
