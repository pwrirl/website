      ...
      <div className="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row gap-12">
        ...
        <section className="flex-1">
          ...
          <p className="text-gray-400 max-w-2xl mb-12 text-lg">
            A comprehensive guide to setting up Streamlabs Mobile for IRL streaming on iOS. Learn how to configure your stream settings, optimize performance, and start broadcasting with professional quality.
          </p>
