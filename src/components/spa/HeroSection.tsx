      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-4">
          ...
          <a
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-md border-2 border-white px-4 py-3 text-center text-base font-medium text-white transition-colors hover:bg-white/10 sm:w-auto sm:px-6 sm:py-3 sm:text-base"
          >
